...
import 'package:finding_red/components/utils.dart';
...
class Player extends SpriteAnimationGroupComponent
    with HasGameRef<FindingRed>, KeyboardHandler, CollisionCallbacks {
  String character;
  double levelNumber = 1;
  double sawColNo = 0;
  Player({position, this.character = 'Ninja Frog', this.levelNumber = 1})
  ...
  void onCollisionStart(
    ...
    if (!reachedCheckpoint) {
      if (other is Fruit) {
        if (other.levelNum == levelNumber) {
          other.colloindedWithPlayer();
          print(levelNumber);
          game.updateScore(1);
        }
      }
  ...
  void _updatePlayerMovement(double dt) {
    ...
    // if (velocity.y > _gravity) isOnGround = false; //DIsables mid-air jump
    velocity.x = horizontalMovement * movesSpeed;
  ...
  void _reachedCheckpoint() {
    ...
    Future.delayed(reachedCheckpointDuration, () {
      ...
      print("Checkpoint reached = false");
